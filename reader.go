...
func (SjReader) ReadAsStrFrom(readFilePath io.Reader) (contentAsStr string, err error) {
...
func (SjReader) ReadAsByteFrom(readFilePath io.Reader) (contentAsByte []byte, err error) {
	var jsonByte []byte = make([]byte, 0)
...
func (SjReader) ReadAsMapFrom(readFilePath io.Reader) (contentAsMap map[int]map[string]any, err error) {
	var (
