...
func main() {
	sj := sjrw.Sj{ReadJsonPath: "C:/Users/ns072/OneDrive/ドキュメント/Github/sjrw/testdata/difftest.json"}
	str := `
	{
    "add": [
        "git add .",
	...
	`
	sj.WriteFromStr(str, "C:/Users/ns072/OneDrive/ドキュメント/Github/sjrw/testdata/write2.json")
}